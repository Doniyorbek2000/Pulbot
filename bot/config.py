...
class Settings(BaseSettings):
    ...
    jwt_secret: str = Field(default="super-secret-pulbot-jwt-key", alias="JWT_SECRET")
    ...
    cryptobot_net: str = Field(default="mainnet", alias="CRYPTOBOT_NET")  # 'mainnet' or 'testnet'
